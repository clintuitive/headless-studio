...
title: About
slug: about
description: The Headless Studio — music production as code, written by Clint Johnson.
---
...
The articles cover the load-bearing tricks, written for working developers.
**The Headless Studio** — the book — covers the whole system, and takes the
gentler road: written for intermediate programmers with no audio background
and only surface-level Python, every idiom and every audio concept explained
on first use. The blog assumes expertise; the book builds it.
...
No paywall, no catch — take it, use it, make something. If it saves you an
afternoon and you feel like it, you can
[buy me a coffee](https://buymeacoffee.com/clintjohnson) — always optional.
